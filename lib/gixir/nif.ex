defmodule Gixir.Nif do
  ...
  def repository_branches(_), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def commit_tree(_, _), do: :erlang.nif_error(:nif_not_loaded)
  def tree_get_by_oid(_, _), do: :erlang.nif_error(:nif_not_loaded)
end
